...
# aws_s3_bucket.firstbuck will be created

- resource "aws_s3_bucket" "firstbuck" {
  - acceleration_status = (known after apply)
  - acl = (known after apply)
  - arn = (known after apply)
  - bucket = " techtutorialswithPiyushDay14"
...
Terraform will perform the following actions:
  ...
  + resource "aws_cloudfront_distribution" "s3_distribution" {
      ...
      + origin {
          ...
          + s3_origin_config {
              + origin_access_identity = "origin-access-identity/cloudfront/AB###@@@@###@@@@34567"
            }
        }
  ...
  # aws_cloudfront_origin_access_control.origin will be created
