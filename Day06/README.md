...
🔹 **variables.tf**
Defines input variables used across the configuration.

🔹 **outputs.tf**
Exposes useful information after infrastructure is created (IDs, ARNs, etc.).

🔹 **providers.tf**
Configures the cloud provider (AWS, Azure, GCP).

🔹 **terraform.tfvars**
Stores variable values for environments.

🔹 **backend.tf**
Configures the remote backend (e.g., S3 for Terraform state).
...
Looking forward to continuing the challenge and learning more about Terraform and AWS infrastructure automation.
